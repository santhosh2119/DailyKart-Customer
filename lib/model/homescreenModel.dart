...
class HomeScreenModel{
  ...
  List<BannerDataNew> bannerInfo;
  List<CategoryDataNew> categoryNewList;
  List<ProductInfoModel> newArrivalList;
  List<ProductInfoModel> recentlyViewedList;
  ...
  bindBannerInfo(List<BannerDataNew> bannerList){
    bannerInfo=bannerList;
  }
  bindCategoryInfo(List<CategoryDataNew> newCategoryList){
    categoryNewList = newCategoryList;
    categories = newCategoryList;
  }
  void bindNewArrivalProducts(List<ProductInfoModel> newArrivals ) {
    this.newArrivalList = newArrivals;
  }
  void bindRecentlyViewedProducts(List<ProductInfoModel> recentlyViewedProduts) {
    this.recentlyViewedList = recentlyViewedProduts;
  }
