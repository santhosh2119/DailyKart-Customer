...
class IBanner extends StatefulWidget {
  final List<BannerDataNew> dataPromotion;
  final double width;
...
class _IBannerState extends State<IBanner> {
  ...
  _sale2(BannerDataNew item, int index){
    var _id = UniqueKey().toString();

    return InkWell(
        onTap: () {
      if (widget.callback != null)
        widget.callback(item.id, _id, item.images);
    }, // needed
    child: Stack(
      children: <Widget>[
        Container(
          ...
          Hero(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                    ...
                    imageUrl: AppConstants.IMAGE_STAGE_BASE_URL+ item.images,
