...
class Menu extends StatelessWidget {
  ...
  _onMenuClickItem(int id){
    ...
    switch(id){
      ...
      case 9:   // Language
        //callback("language");
        callback(AppConstants.menu_offers);
        break;
      ...
      case 20:   // about
        //callback("about");
        callback(AppConstants.menu_about_us);
        break;
      case 21:   // delivery
        //callback("delivery");
        callback(AppConstants.menu_contact);
        break;
      case 22:   // privacy
        //callback("privacy");
        callback(AppConstants.menu_share_and_rewards);
        break;
      case 23:   // terms
        //callback("terms");
        callback(AppConstants.menu_payments);
        break;
      case 24:   // refund
        callback("refund");
        break;
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              _item(23,AppConstants.menu_payments, "assets/doc.png"),
              _item(2, strings.get(35), "assets/notifyicon.png"),  // Notifications
              _item(9,AppConstants.menu_offers, "assets/icon_offer.png"),
              ...
              if (appSettings.about == "true")
                _item(20, AppConstants.menu_about_us, "assets/icon_about.png"),

                _item(21,AppConstants.menu_contact_us, "assets/icon_contact_us.png"),
              _item(22,AppConstants.menu_share_and_rewards, "assets/icon_share.png"),
