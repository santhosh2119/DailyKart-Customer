...
class _WalletScreenState extends State<WalletScreen> {
  ...
  _pressTopUpNow() async {
    ...
    var razorpayCompanyName = homeScreenViewModel.mainWindowData.payments.razName;
    var code = homeScreenViewModel.mainWindowData.payments.code;
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => PaypalPayment(
              ...
              userEmail: "",
              payAmount: _total,
              secret: homeScreenViewModel.mainWindowData.payments.payPalSecret,
              clientId: homeScreenViewModel.mainWindowData.payments.payPalClientId,
              sandBoxMode: homeScreenViewModel.mainWindowData.payments.payPalSandBoxMode,
              onFinish: (w){
                _onSuccess("PayPal: $w");
              }
          ),
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => InstaMojoPayment(
              ...
              token: homeScreenViewModel.mainWindowData.payments.instamojoPrivateToken,
              apiKey: homeScreenViewModel.mainWindowData.payments.instamojoApiKey,
              sandBoxMode: homeScreenViewModel.mainWindowData.payments.instamojoSandBoxMode,
              onFinish: (w){
    ...
    return Scaffold(
        ...
        Stack(
          children: <Widget>[
            ...
            headerWidget(context, widget.onBack, theme.colorDefaultText, strings.get(206)), // "Wallet",
  ...
  _body2(){
    ...
    if (!_topUpStart) {
      ...
      if (homeScreenViewModel.mainWindowData.payments.stripeEnable == "true") {
        list.add(_item("assets/payment2.png", 4, strings.get(192))); // "Visa, Mastercard",
        list.add(SizedBox(height: 10,));
      }
      if (homeScreenViewModel.mainWindowData.payments.razEnable == "true") {
        list.add(_item("assets/payment4.png", 3, strings.get(191))); // razorpay
        list.add(SizedBox(height: 10,));
      }
      if (homeScreenViewModel.mainWindowData.payments.payPalEnable == "true") {
        list.add(_item("assets/payment5.png", 5, strings.get(249))); // payPal
        list.add(SizedBox(height: 10,));
      }
      if (homeScreenViewModel.mainWindowData.payments.payStackEnable == "true") {
        list.add(_item("assets/payment7.png", 7, strings.get(251))); // payStack
        list.add(SizedBox(height: 10,));
      }
      if (homeScreenViewModel.mainWindowData.payments.yandexKassaEnable == "true") {
        list.add(_item("assets/payment8.png", 8, strings.get(265))); // Yandex kassa
        list.add(SizedBox(height: 10,));
      }
      if (homeScreenViewModel.mainWindowData.payments.instamojoEnable == "true") {
