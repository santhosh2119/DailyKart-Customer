...
import 'package:fooddelivery/ui/main/chat/chat.dart';
import 'package:fooddelivery/ui/main/favorites_screen.dart';
import 'package:fooddelivery/ui/main/home/home.dart';
import 'package:fooddelivery/ui/main/notification_screen.dart';
import 'package:fooddelivery/ui/main/offers_screen.dart';

import 'package:fooddelivery/ui/main/orders/orderdetails.dart';
import 'package:fooddelivery/ui/main/orders/orders.dart';
import 'package:fooddelivery/ui/menu/about_us.dart';
import 'package:fooddelivery/ui/menu/contact_us_screen.dart';
...
import 'package:fooddelivery/ui/menu/rewards_screen.dart';
...
class _MainScreenState extends State<MainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    //
    String _headerText = strings.get(33);  // "Home",33
    switch(_currentPage){
      case 1:
        _headerText = strings.get(38); // "Favorites",38
        break;
      case 2:
        _headerText = strings.get(37);  // "Account",37
        break;
      case 3:
        _headerText = strings.get(36); // "My Orders",36
        break;
    // case 4:
    //   _headerText = strings.get(38);
    //   break;
    }
    ...
    return WillPopScope(
        onWillPop: () async {
          ...
          if (_currentState == AppConstants.menu_about_us ||
              _currentState == AppConstants.menu_contact ||
              _currentState == AppConstants.menu_share_and_rewards ||
              _currentState == AppConstants.menu_payments||
              _currentState == AppConstants.menu_offers||
              _currentState == "delivery" ||
              _currentState == "privacy" ||
              _currentState == "terms" ||
              _currentState == "refund" ||
              _currentState == "faq" ||
              _currentState == "language" ||
              _currentState == "chat" ||
              _currentState == "notify" ||
              _currentState == "wallet" ||
            ...
            children: <Widget>[
              ...
              if (appSettings.bottomBarType == "type1")
                IBottomBar(colorBackground: appSettings.bottomBarColor, colorSelect: theme.colorPrimary,
                    ...
                    icons: ["assets/home.png", "assets/favorites.png", "assets/account.png", "assets/orders.png"]
                ),
              ...
              if(_currentState == AppConstants.menu_about_us)
                AboutUsScreen(doc: _currentState, onBack: onBack),

              if(_currentState == AppConstants.menu_contact)
                ContactUsScreen(doc: _currentState, onBack: onBack),

              if(_currentState == AppConstants.menu_share_and_rewards)
                RewardsScreen(doc: _currentState, onBack: onBack),

              if(_currentState == AppConstants.menu_payments)
                RewardsScreen(doc: _currentState, onBack: onBack),

              if(_currentState == AppConstants.menu_offers)
                OffersScreen(doc: _currentState, onBack: onBack),

              if ( _currentState == "delivery" || _currentState == "privacy"
  ...
  routes(String route){
    ...
    if (route == AppConstants.menu_about_us ||
        route == AppConstants.menu_contact ||
        route == AppConstants.menu_share_and_rewards ||
        route == AppConstants.menu_payments ||
        route == AppConstants.menu_offers ||
        route == "delivery" ||
        route == "privacy" ||
        route == "terms" ||
        route == "refund" ||
