...
class _DeliveryScreenState extends State<DeliveryScreen>
  ...
  _initDistance() async {
    if (_areakm != -1){
      ...
      distance = await homeScreenViewModel.location.distanceBetween(_deliveryLatitude, _deliveryLongitude, restLat, restLng);
      if (distance == -1)
        return;
...
//      minuteInterval: 1,
  ...
  _onCouponEnter(String value){
    _couponEnable = false;
    for (var coupon in homeScreenViewModel.mainWindowData.coupons)
