  ...
  _loadNotificationsData(){
    NetworkUtils.isNetwork().then((intenet) {
      if (intenet != null && intenet) {
        ...
        CommonMethods.getApiRepository().getNotificationsData(body).then((response) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        Stack(
          ...
          headerWidget(context, widget.onBack, theme.colorDefaultText, strings.get(35)), // "Notifications",
